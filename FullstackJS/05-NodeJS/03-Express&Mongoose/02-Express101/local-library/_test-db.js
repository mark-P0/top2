...
(async () => {
  ...
  const { Book } = await import("./model/book.mjs");
  const { Author } = await import("./model/author.mjs");
  const { Genre } = await import("./model/genre.mjs");
  const { BookInstance } = await import("./model/book-instance.mjs");
